...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.pic_url'
        db.add_column('friend_document', 'pic_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.pic_url'
        db.delete_column('friend_document', 'pic_url')
