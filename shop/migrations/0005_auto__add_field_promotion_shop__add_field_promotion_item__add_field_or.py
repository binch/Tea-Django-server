...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Promotion.shop'
        db.add_column('shop_promotion', 'shop', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='promotions', to=orm['shop.Shop']), keep_default=False)

        # Adding field 'Promotion.item'
        db.add_column('shop_promotion', 'item', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='promotions', to=orm['shop.Item']), keep_default=False)

        # Adding field 'Order.addr'
        db.add_column('shop_order', 'addr', self.gf('django.db.models.fields.CharField')(default='', max_length=2550), keep_default=False)

        # Adding field 'Order.phone'
        db.add_column('shop_order', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=2550), keep_default=False)

        # Adding field 'Order.contact'
        db.add_column('shop_order', 'contact', self.gf('django.db.models.fields.CharField')(default='', max_length=2550), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Promotion.shop'
        db.delete_column('shop_promotion', 'shop_id')

        # Deleting field 'Promotion.item'
        db.delete_column('shop_promotion', 'item_id')

        # Deleting field 'Order.addr'
        db.delete_column('shop_order', 'addr')

        # Deleting field 'Order.phone'
        db.delete_column('shop_order', 'phone')

        # Deleting field 'Order.contact'
        db.delete_column('shop_order', 'contact')
