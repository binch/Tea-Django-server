...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.pay'
        db.add_column('shop_order', 'pay', self.gf('django.db.models.fields.CharField')(default='cod', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.pay'
        db.delete_column('shop_order', 'pay')
