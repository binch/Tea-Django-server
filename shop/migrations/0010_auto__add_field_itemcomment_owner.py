...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ItemComment.owner'
        db.add_column('shop_itemcomment', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='itemcomments', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ItemComment.owner'
        db.delete_column('shop_itemcomment', 'owner_id')
    ...
    models = {
        ...
        'shop.itemcomment': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'itemcomments'", 'null': 'True', 'to': "orm['auth.User']"}),
