...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_order', 'status', self.gf('django.db.models.fields.CharField')(default='new', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.status'
        db.delete_column('shop_order', 'status')
