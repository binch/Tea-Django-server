...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shop_item', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.ShopCategory']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Item.category'
        db.alter_column('shop_item', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Category']))
