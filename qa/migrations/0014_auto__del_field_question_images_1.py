...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Question.images_1'
        db.delete_column('qa_question', 'images_1')


    def backwards(self, orm):
        
        # Adding field 'Question.images_1'
        db.add_column('qa_question', 'images_1', self.gf('django.db.models.fields.CharField')(default='', max_length=2550), keep_default=False)
