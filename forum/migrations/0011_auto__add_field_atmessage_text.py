...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AtMessage.text'
        db.add_column('forum_atmessage', 'text', self.gf('django.db.models.fields.CharField')(default='', max_length=2550), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AtMessage.text'
        db.delete_column('forum_atmessage', 'text')
