...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AtMessage.read'
        db.add_column('forum_atmessage', 'read', self.gf('django.db.models.fields.CharField')(default='unread', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AtMessage.read'
        db.delete_column('forum_atmessage', 'read')
