...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.nickname'
        db.add_column('forum_userinfo', 'nickname', self.gf('django.db.models.fields.CharField')(default='', max_length=2550), keep_default=False)

        # Adding field 'UserInfo.thumb'
        db.add_column('forum_userinfo', 'thumb', self.gf('django.db.models.fields.CharField')(default='', max_length=2550), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.nickname'
        db.delete_column('forum_userinfo', 'nickname')

        # Deleting field 'UserInfo.thumb'
        db.delete_column('forum_userinfo', 'thumb')
    ...
    models = {
        ...
        'forum.thread': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images_1': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
        ...
        'forum.userinfo': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nickname': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2550'}),
            'point': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'thumb': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2550'}),
