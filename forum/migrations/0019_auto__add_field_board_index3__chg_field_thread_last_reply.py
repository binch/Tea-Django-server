...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Board.index3'
        db.add_column('forum_board', 'index3', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Thread.last_reply'
        db.alter_column('forum_thread', 'last_reply', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Deleting field 'Board.index3'
        db.delete_column('forum_board', 'index3')

        # Changing field 'Thread.last_reply'
        db.alter_column('forum_thread', 'last_reply', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
