...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Board.desc'
        db.add_column('forum_board', 'desc', self.gf('django.db.models.fields.TextField')(default='test'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Board.desc'
        db.delete_column('forum_board', 'desc')
