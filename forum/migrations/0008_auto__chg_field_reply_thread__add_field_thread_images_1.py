...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reply.thread'
        db.alter_column('forum_reply', 'thread_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Thread']))

        # Adding field 'Thread.images_1'
        db.add_column('forum_thread', 'images_1', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Reply.thread'
        db.alter_column('forum_reply', 'thread_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['forum.Board']))

        # Deleting field 'Thread.images_1'
        db.delete_column('forum_thread', 'images_1')
