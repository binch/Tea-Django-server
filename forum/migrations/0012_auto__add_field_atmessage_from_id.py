...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AtMessage.from_id'
        db.add_column('forum_atmessage', 'from_id', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AtMessage.from_id'
        db.delete_column('forum_atmessage', 'from_id')
