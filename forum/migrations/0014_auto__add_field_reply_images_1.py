...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reply.images_1'
        db.add_column('forum_reply', 'images_1', self.gf('django.db.models.fields.CharField')(default='', max_length=2550), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Reply.images_1'
        db.delete_column('forum_reply', 'images_1')
