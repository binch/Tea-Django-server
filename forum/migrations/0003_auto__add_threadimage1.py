...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ThreadImage1'
        db.create_table('forum_threadimage1', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thread', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images1', to=orm['forum.Thread'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('forum', ['ThreadImage1'])


    def backwards(self, orm):
        
        # Deleting model 'ThreadImage1'
        db.delete_table('forum_threadimage1')
    ...
    models = {
        ...
        'forum.threadimage1': {
            'Meta': {'object_name': 'ThreadImage1'},
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'thread': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images1'", 'to': "orm['forum.Thread']"})
        },
        'forum.userinfo': {
