...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AtMessage.user'
        db.add_column('forum_atmessage', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='atmessages', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AtMessage.user'
        db.delete_column('forum_atmessage', 'user_id')
