...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.deviceid'
        db.add_column('forum_userinfo', 'deviceid', self.gf('django.db.models.fields.CharField')(default='', max_length=2550, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.deviceid'
        db.delete_column('forum_userinfo', 'deviceid')
